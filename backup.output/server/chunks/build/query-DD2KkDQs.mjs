import { C as withLeadingSlash, y as joinURL, D as withoutTrailingSlash, I as withBase, F as hash } from '../_/nitro.mjs';
import { c as useRuntimeConfig, g as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BgVVr79Y.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DD2KkDQs.mjs.map
