...
import { u as useAsyncData } from './asyncData-WeAjXoGm.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DD2KkDQs.mjs';
import { u as useContentPreview } from './preview-BWO419hx.mjs';
import { m as useState, c as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BgVVr79Y.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BQGA09sc.mjs.map
