        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (isLoading.value) {
              ...
              _push2(`<div class="overflow-x-auto text-center justify-center items-center"${_scopeId}><p class="text-sm md:text-xl lg:text-2xl xl:text-3xl font-bold"${_scopeId}> Welcome back, ${ssrInterpolate((_a = unref(auth).user) == null ? void 0 : _a.name)}. <br${_scopeId}> You&#39;re a VIP user. </p></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              isLoading.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("p", { class: "text-sm md:text-xl lg:text-2xl xl:text-3xl font-bold" }, [
                  createTextVNode(" Welcome back, " + toDisplayString((_b = unref(auth).user) == null ? void 0 : _b.name) + ". ", 1),
                  createVNode("br"),
                  createTextVNode(" You're a VIP user. ")
                ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layers/admin/pages/admin/vip/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-C0AYey76.mjs.map
